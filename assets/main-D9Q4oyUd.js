import"./auth.service-jTKzoafw.js";import{l as p,a as u,p as n}from"./footer-yy1v75yP.js";import{c as l,f as s}from"./currency-BUz-WTj3.js";import{s as a}from"./dom-Dz1M3mpB.js";async function m(){await p(),u();const d="/virtual-store/",i=document.getElementById("featured-products"),o=document.getElementById("offer-products");try{const e=await n.getFeaturedProducts(4);i.innerHTML=e.map(r=>{var c;const t=l(r.price,r.offer_price);return`
