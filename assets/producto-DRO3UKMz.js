import{a as B}from"./auth.service-BfASCOUI.js";import{l as w,a as S,p as k,c as x}from"./footer-BXBpEo4g.js";import{p as m}from"./profile.service-BKi9D-xX.js";import{c as F,f as E}from"./currency-BUz-WTj3.js";import{s as n}from"./dom-Dz1M3mpB.js";import{s as u,a as p}from"./notifications-DBxoMB4P.js";const v="/virtual-store/",_=new URLSearchParams(window.location.search),I=_.get("id");I||(window.location.href=`${v}catalogo.html`);async function H(){var g,f;await w(),S();const d=document.getElementById("product-container");try{const t=await k.getProductById(I);if(!t||!t.is_active){d.innerHTML='<div class="empty-state" style="padding:4rem 0"><div class="empty-state-icon">📦</div><div class="empty-state-title">Producto no encontrado</div><a href="./catalogo.html" class="btn btn-primary">Ver catálogo</a></div>';return}const L=await k.getProductImages(t.id),c=[t.main_image_url,...L.map(a=>a.image_url)].filter(Boolean),q=F(t.price,t.offer_price),l=await B.getSession(),s=(g=l==null?void 0:l.user)==null?void 0:g.id;let r=!1;if(s&&(r=await m.isFavorite(s,t.id)),d.innerHTML=`
          <div class="breadcrumb" style="padding-top:1rem;font-size:0.875rem"><a href="${v}index.html">Inicio</a> / <a href="${v}catalogo.html">Catálogo</a> / ${n(t.name)}</div>
