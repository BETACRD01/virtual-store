      ...
      <div class="container">
        <div class="header-inner">
          ...
          <div class="header-actions">
            ...
            ${i}
            <a href="${e}carrito.html" title="Carrito" aria-label="Carrito de compras">
              🛒
    ...
    <nav class="nav" id="main-nav">
      <div class="container">
        <div class="nav-list">
          ...
          <a href="${e}catalogo.html">Todos los productos</a>
          ${l}
        </div>
      </div>
    </nav>
  `;const f=document.getElementById("global-search");if(f){let p;f.addEventListener("input",()=>{clearTimeout(p),p=setTimeout(()=>{const d=f.value.trim();window.location.href=`${e}catalogo.html${d?`?busqueda=${encodeURIComponent(d)}`:""}`},500)})}const m=document.getElementById("mobile-menu-btn"),h=document.getElementById("main-nav");m&&h&&m.addEventListener("click",()=>h.classList.toggle("open"))}function M(){const t=document.getElementById("main-footer");if(!t)return;const e="/virtual-store/";t.innerHTML=`
    <footer class="footer">
      <div class="container">
        <div class="footer-grid">
          ...
          <div>
            <h3>Tienda</h3>
            <a href="${e}index.html">Inicio</a>
            <a href="${e}catalogo.html">Catálogo</a>
            <a href="${e}catalogo.html?ofertas=true">Ofertas</a>
          </div>
          <div>
            <h3>Mi cuenta</h3>
            <a href="${e}login.html">Iniciar sesión</a>
            <a href="${e}registro.html">Registrarse</a>
