import"./auth.service-BxJS2Ta1.js";import{l as k,a as S,c as T}from"./footer-DkVHHXvB.js";import{p as v}from"./profile.service-B8eeLRhV.js";import{o as j}from"./orders.service-Bt366Bu8.js";import{f}from"./currency-BUz-WTj3.js";import{s as a,d as q,e as z}from"./dom-Dz1M3mpB.js";import{a as E,s as h}from"./notifications-DBxoMB4P.js";import{a as M}from"./auth.guard-D-oprmKr.js";const _="/virtual-store/";let b=1,s=null,o="cash";async function C(){const y=await M();if(!y)return;await k(),S();const p=y.user.id,n=await T.getCart(p);if(!n.length){window.location.href=`${_}pagina/carrito.html`;return}async function i(){var $,w;const c=document.getElementById("checkout-form"),m=document.getElementById("checkout-summary"),d=await v.getAddresses(p),g=n.reduce((e,t)=>{var r,l;return e+(t.quantity||1)*(t.unit_price||((r=t.product)==null?void 0:r.offer_price)||((l=t.product)==null?void 0:l.price)||0)},0),u=g>999?0:99,A=g+u;if(m.innerHTML=`<div class="card" style="padding:1.5rem;position:sticky;top:100px">
