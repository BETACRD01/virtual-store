import{a as E}from"./auth.service-BfASCOUI.js";import{l as u,a as q,c as d}from"./footer-BXBpEo4g.js";import{f as i}from"./currency-BUz-WTj3.js";import{s as h}from"./dom-Dz1M3mpB.js";import"./notifications-DBxoMB4P.js";const f="/virtual-store/";async function _(){var p;await u(),q();const l=await E.getSession(),n=(p=l==null?void 0:l.user)==null?void 0:p.id;async function s(){var g,b;const o=await d.getCart(n),y=document.getElementById("cart-items"),v=document.getElementById("cart-summary");if(!o.length){y.innerHTML='<div class="empty-state"><div class="empty-state-icon">🛒</div><div class="empty-state-title">Tu carrito está vacío</div><p>Explora nuestros productos y agrega lo que te guste.</p><a href="./catalogo.html" class="btn btn-primary" style="margin-top:1rem">Ver catálogo</a></div>',v.innerHTML="";return}y.innerHTML=o.map(t=>{const a=t.product||{},e=t.unit_price||a.offer_price||a.price||0;return`<div class="card cart-item">
            ...
            <div>
              <div class="cart-item-name"><a href="${f}producto.html?id=${a.id}">${h(a.name||"Producto")}</a></div>
